                    ...
                    <article class="article reveal uk-animation-slide-left-small">
                        ...
                        <header class="article-header">
                         ...
                         <div class="article-comments" id="article-comments">
                            <iframe src="https://www.ouorz.com/wp-content/themes/peg/comm/index.html?id=<?php echo $post->ID; ?>" style="width: 100%;height: 100%;" frameborder="0" ></iframe>
                         </div>
                         </div>
                    </article>
...
window.onload = function(){ //避免爆代码
        ...
        var post_info = new Vue({ //axios获取顶部信息
            ...
            mounted () {
                ...
                //获取文章
                axios.get('https://www.ouorz.com/wp-json/wp/v2/pages/'+<?php echo $post->ID; ?>)
                 .then(response => {
