...
<?php setPostViews($post->ID); ?>  
                    ...
                    <article class="article reveal uk-animation-slide-left-small">
                        ...
                        <header class="article-header">
                            <span class="badge badge-pill badge-danger single-badge"><a href="https://www.ouorz.com" style="text-decoration:none"><i class="czs-read-l" style="margin-right:5px;"></i>博客文章</a></span>
...
window.onload = function(){ //避免爆代码
        ...
        var post_info = new Vue({ //axios获取顶部信息
            ...
            mounted () {
                ...
                //获取文章
                axios.get('https://www.ouorz.com/wp-json/wp/v2/posts/'+<?php echo $post->ID; ?>)
                 .then(response => {
